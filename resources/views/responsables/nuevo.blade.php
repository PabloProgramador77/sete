                ...
                <form role="form" id="formulario" novalidate>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="titulo" placeholder="Director, Subdirector, etc.">
                        </div>
                    </div>
...
<script src="{{asset('js/responsables/registrar.js')}}" type="text/javascript"></script>
