        ...
        <div class="col-6 m-auto">
            <div class="card">
                ...
                <div class="col-12 m-auto bg-light">
                    <p class="p-3 fs-6 fw-semibold">Una vez realizado el pago, nosotros realizaremos el trámite del título electrónico con el archivo XML generado. <b>Puede tardar hasta 72 hrs</b>.</p>
                </div>
                <form role="form" id="formulario" novalidate >
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group col-6" style="float: left;">
                            ...
                            <input type="text" class="form-control" id="precio" readonly="true" value="1482">
                        </div>
                        <div class="form-group" >
                            <label for="descripcion">Descripción</label>
                            <input type="text" class="form-control" id="descripcion" readonly="true" value="Pago y tramite de título electrónico">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary btn-block" id="registrar"><b>Pagar y Tramitar Título Electrónico</b></button>
                    </div>
