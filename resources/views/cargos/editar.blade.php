...
<div class="content-wrapper" style="min-height: 1302.13px;">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Edición de cargo(s)</h1>
                </div>
                <div class="col-sm-6">
                ...
                <form role="form" id="formulario" novalidate>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nombre" placeholder="Federal, Estatal, etc." value="{{$cargo->nombreCargo}}">
                        </div>
                    </div>
...
<script src="{{asset('js/cargos/actualizar.js')}}" type="text/javascript"></script>
